...
program.command('keypair')
  ...
  .addOption(new Option('--hostname <url>', 'set Armor ⛨ hostname').hideHelp())
  .addOption(new Option('--team <team>', 'team to generate keypair for').hideHelp())
  .addOption(new Option('--metadata <json>', 'json metadata').hideHelp())
  .addOption(new Option('--public-key <key>', 'existing public key').hideHelp())
  .option('--no-armor', 'disable dotenvx-armor features')
  .addOption(new Option('--no-ops', 'disable dotenvx-ops features (deprecated. use --no-armor)').hideHelp())
  .option('-pp, --pretty-print', 'pretty print output')
  .option('--pp', 'pretty print output (alias)')
